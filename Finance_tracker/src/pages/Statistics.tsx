...
import MoneySpentPieChart from "../components/StatiscticsComponents/MoneySpent_PieChart";
import CategoriesPieChart from "../components/StatiscticsComponents/Categories_PieChart";
